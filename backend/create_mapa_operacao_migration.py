#!/usr/bin/env python3
"""
Create Mapa da Operação tables migration
"""
import os
import sys
...
def create_mapa_operacao_tables():
    """Create Mapa da Operação tables"""
    
    sql_file = "mapa_operacao_migration.sql"
...
"""
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            print("✅ Mapa da Operação tables created successfully!")
