...
from .routers import auth, eventos, usuarios, empresas, listas, transacoes, checkins, dashboard, relatorios, whatsapp, cupons, n8n, pdv, gamificacao, produtos_final  # versão final para produção
...
app.include_router(produtos_final.router, prefix="/api", tags=["Produtos"])  # Versão final para produção
