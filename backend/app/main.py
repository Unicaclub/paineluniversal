...
from .routers import auth, eventos, usuarios, empresas, listas, transacoes, checkins, dashboard, relatorios, whatsapp, cupons, n8n, pdv, financeiro, gamificacao, equipe, estoque, meep_analytics, mapa_operacao, marketing_crm
...
app.include_router(equipe.router, prefix="/api")
app.include_router(estoque.router, prefix="/api")
app.include_router(meep_analytics.router, prefix="/api")
app.include_router(mapa_operacao.router, prefix="/api")
app.include_router(marketing_crm.router, prefix="/api")
